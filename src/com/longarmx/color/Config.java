...
public class Config {
	...
	public static final int PLAYER_RED = Keys.A;
	public static final int PLAYER_GREEN = Keys.S;
	public static final int PLAYER_BLUE = Keys.D;
	
	public static final int PLAYER_DARK = Keys.J;
